...
export function fetchLocalRuntimes(): Promise<LocalRuntimesResponse> {
  return getJson<LocalRuntimesResponse>('/local-runtimes')
}

export function fetchEndpointHealth(): Promise<EndpointHealthResponse> {
  return getJson<EndpointHealthResponse>('/endpoint-health')
}
