...
export interface AnthropicMessagesResponse {
  ...
  role: 'assistant'
  model: string
  content: (AnthropicTextBlock | AnthropicThinkingBlock | AnthropicToolUseBlock)[]
...
export interface OpenAIChatResponse {
  ...
  usage?: {
    ...
    total_tokens: number
    // Cached-prompt breakdown (OpenAI server-side prompt caching). Not all
    // OpenAI-compatible providers return this — treat absence as zero cache.
