 ...
 * Only retries on 5xx or connection errors. Never retries 4xx or provider
 * timeouts; a timeout has already consumed the wall-clock budget and should
 * be surfaced for an explicit user/operator retry.
 */
