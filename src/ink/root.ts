...
export type Instance = {
  ...
  cleanup: () => void
  enqueueStaticCommit: Ink['enqueueStaticCommit'] // watermark-v2
  /**
   * Hand the terminal over to an external TUI (editor, imperative picker).
   * Pauses Ink's render loop and suspends stdin. Call exitAlternateScreen
   * when done. Safe to call re-entrantly; a no-op if already paused.
   */
  enterAlternateScreen: Ink['enterAlternateScreen']
  exitAlternateScreen: Ink['exitAlternateScreen']
}
...
export const renderSync = (
  ...
  return {
    ...
    enqueueStaticCommit: instance.enqueueStaticCommit.bind(instance),
    enterAlternateScreen: instance.enterAlternateScreen.bind(instance),
    exitAlternateScreen: instance.exitAlternateScreen.bind(instance),
  }
}
