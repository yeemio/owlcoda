...
export const MODEL_OUTPUT_PROVIDER_MATRIX_FIXTURES: ModelOutputProviderMatrixFixture[] = [
  {
    ...
    rawText: [
      '{"artifact":"evidence-digest.v1","summary":"简明的伤情与来源摘要。","confidence":0.74,"source_refs":["kimi:source:1"],"risks":[]}',
      'JSON 后的补充说明不应进入产物。',
    ].join('\n'),
    stopReason: 'end_turn',
    inputTokens: 180,
  ...
  },
  {
    ...
    rawText: '{"artifact":"evidence-digest.v1","summary":"截断的长证据摘要","confidence":0.63,"risks":["来源冲突"',
