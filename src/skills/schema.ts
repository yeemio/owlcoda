...
export interface SkillDocument {
  ...
  parentId?: string
  /** Original SKILL.md content for upstream/Claude-style skill packages */
  sourceMarkdown?: string
  /** Provenance plane: where this skill came from. Absent = first-party/learned legacy. */
  origin?: 'first-party' | 'learned' | 'third-party'
  /** Third-party provenance (set when origin === 'third-party'). */
  provenance?: { source: string; pinnedRef: string; integrity: string }
}
