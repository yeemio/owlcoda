          ...
          properties: {
            ...
            verification: {
              ...
              items: {
                ...
                properties: {
                  id: { type: 'string' },
                  kind: { type: 'string', enum: ['file_exists', 'file_contains', 'artifact_count', 'command', 'http_get', 'verification_pack', 'run_verdict_gate', 'none'] },
                  path: { type: 'string' },
                  pattern: { type: 'string' },
                  root: { type: 'string' },
                  glob: { type: 'string' },
    ...
    properties: {
      ...
      verification: {
        ...
        items: {
          ...
          properties: {
            id: { type: 'string' },
            kind: { type: 'string', enum: ['file_exists', 'file_contains', 'artifact_count', 'verification_pack', 'run_verdict_gate', 'http_get', 'command', 'none'] },
            packId: { type: 'string' },
            path: { type: 'string' },
            pattern: { type: 'string' },
            root: { type: 'string' },
