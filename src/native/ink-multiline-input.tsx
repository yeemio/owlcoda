...
export function isComposerInterruptInput(input: string, key: { ctrl?: boolean }): boolean {
  return countInterruptsInInput(input, key) > 0
}
...
export function MultilineInput({
  ...
  useInput((input, key) => {
    if (disabled) return
    if (isComposerInterruptInput(input, key)) return
