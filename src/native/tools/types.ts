...
export interface WriteInput {
  ...
  createDirs?: boolean
  /**
   * Explicit acknowledgment that this write may destroy a protected
   * source-of-truth file (handoff doc, GOAL_CONTRACT, CHANGELOG, …).
   * The protected-source policy refuses destructive overwrites by
   * default; setting this flag is the operator's "I know I'm
   * replacing the file, not just appending to it" signal.
...
export interface EditInput {
   ...
   *  this for renames, mass refactors, or other cases where you've
   *  intentionally chosen an unambiguous oldStr that should match
   *  multiple lines. */
  replaceAll?: boolean
}
