...
export const CAPABILITIES: Capability[] = [
  ...
  { name: 'Prompt caching', status: 'partial', detail: 'cache_control breakpoints on system prompt, last tool, and the conversation prefix (last message) for Anthropic-protocol endpoints (cloud + anthropic_messages local runtimes). OpenAI chat/completions routes strip it during translation.' },
