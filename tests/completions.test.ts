...
describe('shell completions', () => {
  ...
  it('zsh completion includes descriptions', () => {
    ...
    expect(output).toContain('workflow:Execute or resume a native workflow/API plan')
    expect(output).toContain('resume:Resume a saved native workflow run')
    ...
    expect(output).toContain("'--run-id[Workflow run id for workflow resume]:run-id:'")
    expect(output).toContain("'--contract[OwlFootball harness task contract JSON file]:file:_files'")
  })
