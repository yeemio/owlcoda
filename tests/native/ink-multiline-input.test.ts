...
describe('composer interrupt filtering', () => {
  it('treats parsed Ctrl+C as interrupt input instead of printable text', () => {
    expect(isComposerInterruptInput('c', { ctrl: true })).toBe(true)
    expect(isComposerInterruptInput('C', { ctrl: true })).toBe(true)
    expect(isComposerInterruptInput('\u0003', {})).toBe(true)
    expect(isComposerInterruptInput('\u0003\u0003', {})).toBe(true)
    expect(isComposerInterruptInput('c', { ctrl: false })).toBe(false)
  })
})
