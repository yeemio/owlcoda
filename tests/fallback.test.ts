...
describe('buildFallbackChain', () => {
  ...
  it('includes signed-off Kimi in automatic fallback candidates while preserving it as a requested primary', () => {
    const config = mockConfig([
      { id: 'primary', tier: 'balanced' },
      { id: 'kimi-code', tier: 'cloud' },
      { id: 'minimax-m27', tier: 'cloud' },
    ])
