...
import { runDoctor, formatDoctorReport, compareSemver, type DoctorReport } from '../src/doctor.js'
import { assessReplacementReadiness } from '../src/replacement-readiness.js'

describe('compareSemver (doctor registry version check)', () => {
  it('orders major.minor.patch correctly', () => {
    expect(compareSemver('0.14.52', '0.14.49')).toBeGreaterThan(0)
    expect(compareSemver('0.14.49', '0.14.52')).toBeLessThan(0)
    expect(compareSemver('0.14.52', '0.14.52')).toBe(0)
    expect(compareSemver('1.0.0', '0.99.99')).toBeGreaterThan(0)
    expect(compareSemver('0.15.0', '0.14.99')).toBeGreaterThan(0)
  })
  it('tolerates a leading v and malformed segments', () => {
    expect(compareSemver('v0.14.52', '0.14.49')).toBeGreaterThan(0)
    expect(compareSemver('0.14', '0.14.0')).toBe(0)
  })
})
