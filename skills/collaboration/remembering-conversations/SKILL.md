...
description: Search previous AI assistant conversations for facts, patterns, decisions, and context using semantic or text search
...
**Manual/CLI use:** Direct search (below) for humans outside an AI assistant session.
