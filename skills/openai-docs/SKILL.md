...
2. If it fails due to runtime permissions, sandboxing, or network policy, stop and report the blocker. Ask the user to install the MCP server or approve the required network access in their environment.
3. Ask the user to restart Codex after installation.
4. Re-run the doc search/fetch after restart.
